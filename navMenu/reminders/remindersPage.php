...
function deleteData(confirmation,id) {
  if (confirmation == 'yes') {
	window.location="/BillingApplication/navMenu/reminders/deleteReminders.php?reminderId="+id;
  }
}
</script>
<script>
...
<div class="content container">
	<main>
		<div class="row">
		         <div class="col-sm-12">
	  			     <a href="/BillingApplication/navMenu/reminders/addRemindersPage.php">
						<button class="btn btn-info"><i class="bx bx-plus"></i>Add Reminder</button>
					</a>
				</div>
				...
				<table id="table" class="table table-striped" style="width:100%">
					...
					if (mysqli_num_rows($result) > 0) 
					{
						while($row = mysqli_fetch_assoc($result)) 
							...
							echo "<tr>";
							echo "<td>".$count."</td>";
							echo "<td style='white-space: pre-wrap;''>".$row["reminder_msg"]."</td>";
							echo "<td>".$row["date"]."</td>";
							echo 
							"<td>";
									...
									<div class="modal-dialog modal-fullscreen-sm-down">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button type="button" class="btn btn-success" data-bs-dismiss="modal" onclick="deleteData('yes','<?php echo $row['reminder_id']?>')">Yes</button>
